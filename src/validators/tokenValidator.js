...
const tokenSchema = Joi.object({
  ...
  holderName: Joi.string().min(2).max(64).required()
    .messages({
      'string.empty': 'holderName es obligatorio',
      'string.min': 'holderName debe tener al menos 2 caracteres',
      'string.max': 'holderName no puede superar los 64 caracteres'
    })
});
