...
- `npx jest` mockea dependencias y no carga el grafo real de index.js.
  Linea base actual: 221/230 (los 9 fallos de webhooks.test.js son PREEXISTENTES).
  ...
  (M7 F2 finalizacion de facturas, 20 jul). Lo constante son los 9 fallos de
  webhooks.test.js; el resto siempre en verde.
