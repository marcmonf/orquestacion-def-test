...
- `npx jest` mockea dependencias y no carga el grafo real de index.js.
  Linea base actual: 225/234 (los 9 fallos de webhooks.test.js son PREEXISTENTES).
  ...
  contrato/PDF/email, 20 jul). Lo constante son los 9 fallos de webhooks.test.js;
  el resto siempre en verde.
